        ...
        <div class="card-body py-3">
          <div class="alert alert-warning small mb-0" role="alert">
            <div class="d-flex align-items-start">
              ...
              <div>
                <p class="mb-1">
                  В случае ошибок в отображении сведений — обращайтесь к
                  сотрудникам отдела проведения соревнований ФХМ.
                </p>
                <p class="mb-0">
                  При наличии технических проблем — в телеграм-чат для
                  сотрудников спортивных школ
                  <a
