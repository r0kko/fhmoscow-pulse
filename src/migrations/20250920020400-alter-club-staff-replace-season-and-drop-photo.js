...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    await queryInterface
      .removeIndex('club_staff', ['season_id'])
      .catch(() => {});
    await queryInterface.removeColumn('club_staff', 'season_id');
    await queryInterface.addColumn('club_staff', 'season_external_id', {
      type: Sequelize.INTEGER,
      allowNull: true,
    });
    await queryInterface.addColumn('club_staff', 'photo_external_id', {
      type: Sequelize.INTEGER,
      allowNull: true,
    });
  },
