export function renderAccountActivatedEmail() {
  ...
  const text =
    'Здравствуйте!\n\n' +
    'Администратор подтвердил вашу учетную запись в системе АСОУ ПД "Поток". ' +
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; color: #333;">
      ...
      <p style="font-size:16px;margin:0 0 16px;">
        Администратор подтвердил вашу учетную запись в системе <strong>АСОУ ПД "Поток"</strong>.
      </p>
