...
import refereeAssignmentsRouter from './refereeAssignments.js';
import leaguesAccessRouter from './leaguesAccess.js';
...
router.use('/referee-assignments', refereeAssignmentsRouter);
router.use('/leagues-access', leaguesAccessRouter);
...
router.use('/admin/async-jobs', asyncJobsRouter);
