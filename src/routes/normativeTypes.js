...
router.post('/', auth, authorize('ADMIN'), normativeTypeCreateRules, controller.create);
router.get('/:id', auth, authorize('ADMIN'), controller.get);
router.put('/:id', auth, authorize('ADMIN'), normativeTypeUpdateRules, controller.update);
